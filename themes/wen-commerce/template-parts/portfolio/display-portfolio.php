...
<?php
$enable = get_theme_mod( 'wen_commerce_portfolio_option', 'disabled' );
...
$wen_commerce_title       = get_theme_mod( 'wen_commerce_portfolio_title');
$wen_commerce_description = get_theme_mod( 'wen_commerce_portfolio_description' );
