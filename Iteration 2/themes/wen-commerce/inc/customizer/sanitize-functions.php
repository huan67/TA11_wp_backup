<?php
/**
 * WEN Commerce Theme Options Sanitization Functions
 *
 ...
 */
function wen_commerce_sanitize_select( $input, $setting ) {
 ...
 */
function wen_commerce_sanitize_checkbox( $checked ) {
    // Boolean check.
 ...
 */
function wen_commerce_sanitize_post( $input ) {
 ...
 */
function wen_commerce_sanitize_category_list( $input ) {
    if ( '' != $input ) {
        if ( in_array( 0, $input ) ) {
            return '0';
        }
 ...
 *                    the setting default.
 */
function wen_commerce_sanitize_number_range( $number, $setting ) {
